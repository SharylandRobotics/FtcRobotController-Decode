...
@Config
@Autonomous(name="Red Backside V2", group="Autonomous")

public class BackRedV2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Action ThirdShoot = drive.actionBuilder(new Pose2d(35,58, Math.toRadians(90)))
                ...
                .lineToYLinearHeading(19.5,Math.toRadians(157))
                .build();
        Action HumanZone = drive.actionBuilder(new Pose2d(55,19.5, Math.toRadians(157)))
        ...
        Action HumanShoot = drive.actionBuilder(new Pose2d(59,60,Math.toRadians(75)))
                ...
                .lineToYLinearHeading(19.5,Math.toRadians(157))
                .build();
        Action BLueTape = drive.actionBuilder(new Pose2d(55,19.5, Math.toRadians(157)))
        ...
        Action TapeShoot = drive.actionBuilder(new Pose2d(47,60, Math.toRadians(90)))
                ...
                .lineToYLinearHeading(19.5,Math.toRadians(157))
                .build();
        Action TelePosition = drive.actionBuilder(new Pose2d(55,19.5, Math.toRadians(157)))
